// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["lzi","dyttzy","ffzy","ckzy","zy360","mdzy","ruyi","bfzy","ikun"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["lzi","dyttzy","ffzy","ckzy","zy360","mdzy","ruyi","bfzy","ikun"];
