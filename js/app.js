// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["lzi","dyttzy","ffzy","tyyszy","ckzy","zy360","jisu","mdzy","ruyi","bfzy","wujin","ikun"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["lzi","dyttzy","ffzy","tyyszy","ckzy","zy360","jisu","mdzy","ruyi","bfzy","wujin","ikun"];
